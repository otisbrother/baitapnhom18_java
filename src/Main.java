...
public class Main {
    public static void main(String[] args) {
        ...
        classrooms.get("HTTT1").addStudent(new Student("Nguyen Huy", "Toa", "2002-05-10", "Ha Noi", "HTTT1", 9, 8.5, 8, 9, 8.5));
        classrooms.get("HTTT1").addStudent(new Student("Nguyen Manh", "Thang", "2002-06-15", "HCM", "HTTT1", 7, 6.5, 7, 7.5, 6));
        classrooms.get("HTTT3").addStudent(new Student("Dao Dinh ", "Hung", "2002-07-20", "Da Nang", "HTTT3", 5, 5.5, 6, 4, 3.5));
